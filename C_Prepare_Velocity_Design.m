...
load Fish_DU.mat Y_Fish PARA Nx Ny;
lx = Nx; ly = Ny;
X = Y_Fish;
r = 200;
[~,nm] = size(X);
...
for i = 1:length(indx)
    ...
    P{i} = [PARA{k}(1)/1000 PARA{k}(1)/1000 PARA{k}(3)/1000];
end
...
save Velocity_opt.mat Ubaser Atilde B1tilde B2tilde B3tilde Y_Fish PARA Nx Ny
